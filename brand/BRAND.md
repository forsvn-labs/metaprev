...
> **Status:** scaffold only. No brand identity defined yet. Fill in before any dedicated marketing surface ships.
...
## TODO before launch
- [ ] Decide whether metaprev gets a dedicated brand vault + landing page (watch weekly npm downloads first — see `../../state-business.md`).
- [ ] Define palette, type, logo. Until then, default to FORSVN house tokens.
- [ ] Add `DESIGN.md`, logo assets under `logo/`, fonts under `font/`.
