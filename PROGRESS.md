...
Updated: 2026-09-19
Owner: Hung
State: shipped and maintained; current release 0.6.0
...
- `0.6.0` is the accuracy and report-chrome release. GitHub `main` is the shipping record; npm follows the same version.
...
Collect real use feedback from `0.6.0`, then choose the next compatibility fixes. Verify package and
mirror version parity after each publish.
